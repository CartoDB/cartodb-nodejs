 ...
 * When request is complete 'fn' callback is called, 
 * if something went wrong 'error' carry the error within 'fn'
 *
...
CartoDB.prototype.queryOAuth = function(_sql, args, fn) {
